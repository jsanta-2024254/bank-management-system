...
const ProductForm = ({ product, onClose }) => {
  ...
  const {
    ...
    defaultValues: {
      ...
      montoMinimo: product?.montoMinimo ?? 0,
      montoMaximo: product?.montoMaximo ?? 0,
    },
  });
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const payload = {
        ...
        descuentoAppPorcentaje: parseFloat(data.descuentoAppPorcentaje || 0),
        tasaInteres: parseFloat(data.tasaInteres || 0),
        moraPorcentaje: parseFloat(data.moraPorcentaje || 0),
        plazoMesesMinimo: parseInt(data.plazoMesesMinimo || 1),
        plazoMesesMaximo: parseInt(data.plazoMesesMaximo || 60),
        montoMinimo: parseFloat(data.montoMinimo || 0),
        montoMaximo: parseFloat(data.montoMaximo || 0),

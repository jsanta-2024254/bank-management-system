...
const ProductList = () => {
    ...
    const oportunidadesCredito = products.filter((product) => product.tipo === 'credito').length
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="mt-1 text-sm font-semibold text-[#7a6849]">
                                Gestiona productos, servicios, suscripciones y oportunidades de crédito.
                            </p>
                        </div>
                    </div>
                            ...
                            {loading && products.length === 0 ? (
                                ...
                                <AnimatePresence>
                                    {filtered.map((product) => {
                                        ...
                                        const tasaInteres =
                                            product.tasaInteres !== undefined
                                                ? `${product.tasaInteres}%`
                                                : '—'
                                        const estado = product.estado !== false
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <td className="px-8 py-5">
                                                    <span className="inline-flex items-center gap-1.5 rounded-full border border-[#d7bc73]/50 bg-[#fff8df] px-3 py-1 text-xs font-black capitalize text-[#8a611b]">
                                                        <BadgeDollarSign size={12} />
                                                        {tipo}
                                                    </span>
                                                </td>

                                                <td className="px-8 py-5 text-sm font-semibold text-[#7a6849]">
                                                    <span className="inline-flex items-center gap-1">
                                                        <Percent size={13} className="text-[#9a6b16]/70" />
                                                        {tasaInteres}
                                                    </span>
                                                </td>

                                                <td className="px-8 py-5">
                                                    <StatusBadge active={estado} />
                                                </td>

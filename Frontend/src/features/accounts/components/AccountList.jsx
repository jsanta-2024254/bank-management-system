...
const AccountList = () => {
    ...
    const filtered = accounts.filter((account) => {
        ...
        return (
            ...
            (esAdmin && (account.usuario || '').toLowerCase().includes(query))
        )
    })
                    ...
                    <table className="w-full text-left">
                        ...
                        <tbody className="divide-y divide-white/5">
                            {loading && accounts.length === 0 ? (
                                [1, 2, 3].map((i) => (
                                    <tr key={i}>
                                        <td className="px-8 py-5">
                                            <div className="h-10 w-44 rounded-xl bg-zinc-800 animate-pulse" />
                                        </td>
                                        <td className="px-8 py-5">
                                        ...
                                        {esAdmin && (
                                            <>
                                                ...
                                                <td className="px-8 py-5">
                                                    <div className="h-8 w-20 rounded-lg bg-zinc-800 animate-pulse ml-auto" />
                                                </td>
                                            </>
                                        )}
                                    </tr>
                                ...
                                <tr>
                                    <td colSpan={totalColumns} className="px-8 py-16 text-center text-zinc-500">
                                ...
                                <AnimatePresence>
                                    {filtered.map((account) => (
                                        ...
                                        >
                                            ...
                                            {esAdmin && (
                                                <>
                                                    <td className="px-8 py-5 text-zinc-400 text-xs font-mono">
                                                        {account.usuario}
                                                    </td>
                                                    ...
                                                    <td className="px-8 py-5">
                                                        <span className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold ${
                                                            ...
                                                            <span className={`w-1.5 h-1.5 rounded-full ${
                                                                account.estado ? 'bg-green-400' : 'bg-zinc-500'
                                                            }`} />
